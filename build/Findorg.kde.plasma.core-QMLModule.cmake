...
if (QT_MAJOR_VERSION EQUAL "6")
    ...
    # Get the qmldir file
    _ecm_qmlmodule_uri_to_path(MODULEDIR "org.kde.plasma.core" "2.0")
    ...
    if (NOT MODULE_NOTFOUND AND NOT "2.0" STREQUAL "") # Check if we even need to check the version
        ...
        if (VERSION_FILE)
            ...
            if ("${FILE_CONTENTS}" MATCHES "([0-9]+(\\.[0-9]+)*)")
                ...
                set(org.kde.plasma.core-QMLModule_VERSION "${CMAKE_MATCH_1}")
            endif()
        else()
...
if (NOT CMAKE_CROSSCOMPILING AND NOT MODULE_NOTFOUND AND NOT org.kde.plasma.core-QMLModule_FOUND AND (NOT DEFINED QT6_IS_SHARED_LIBS_BUILD OR QT6_IS_SHARED_LIBS_BUILD))
    if (QT_MAJOR_VERSION EQUAL "6")
...
set(org.kde.plasma.core-QMLModule_FOUND ${org.kde.plasma.core-QMLModule_FOUND} PARENT_SCOPE)
set(org.kde.plasma.core-QMLModule_VERSION ${org.kde.plasma.core-QMLModule_VERSION} PARENT_SCOPE)
find_package_handle_standard_args(org.kde.plasma.core-QMLModule
    VERSION_VAR org.kde.plasma.core-QMLModule_VERSION
    REQUIRED_VARS org.kde.plasma.core-QMLModule_FOUND
    HANDLE_COMPONENTS
)
