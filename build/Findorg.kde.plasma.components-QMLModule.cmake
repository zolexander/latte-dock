...
if (QT_MAJOR_VERSION EQUAL "6")
    ...
    # Get the qmldir file
    _ecm_qmlmodule_uri_to_path(MODULEDIR "org.kde.plasma.components" "2.0")
    ...
    if (NOT MODULE_NOTFOUND AND NOT "2.0" STREQUAL "") # Check if we even need to check the version
        ...
        if (VERSION_FILE)
            ...
            if ("${FILE_CONTENTS}" MATCHES "([0-9]+(\\.[0-9]+)*)")
                if ("${CMAKE_MATCH_1}" VERSION_GREATER_EQUAL "2.0")
                    set(org.kde.plasma.components-QMLModule_FOUND TRUE)
                endif()
                set(org.kde.plasma.components-QMLModule_VERSION "${CMAKE_MATCH_1}")
            endif()
        else()
...
if (NOT CMAKE_CROSSCOMPILING AND NOT MODULE_NOTFOUND AND NOT org.kde.plasma.components-QMLModule_FOUND AND (NOT DEFINED QT6_IS_SHARED_LIBS_BUILD OR QT6_IS_SHARED_LIBS_BUILD))
    if (QT_MAJOR_VERSION EQUAL "6")
    ...
    execute_process(COMMAND "${QMLPLUGINDUMP_PROGRAM}" "org.kde.plasma.components" "2.0" ERROR_VARIABLE ERRORS_OUTPUT OUTPUT_VARIABLE DISREGARD_VARIABLE RESULT_VARIABLE ExitCode TIMEOUT 30)
    if(ExitCode EQUAL 0)
        set(org.kde.plasma.components-QMLModule_FOUND TRUE)
    else()
        message(STATUS "qmlplugindump failed for org.kde.plasma.components.")
        set(org.kde.plasma.components-QMLModule_FOUND FALSE)
    endif()
endif()

set(org.kde.plasma.components-QMLModule_FOUND ${org.kde.plasma.components-QMLModule_FOUND} PARENT_SCOPE)
set(org.kde.plasma.components-QMLModule_VERSION ${org.kde.plasma.components-QMLModule_VERSION} PARENT_SCOPE)
find_package_handle_standard_args(org.kde.plasma.components-QMLModule
    VERSION_VAR org.kde.plasma.components-QMLModule_VERSION
    REQUIRED_VARS org.kde.plasma.components-QMLModule_FOUND
    HANDLE_COMPONENTS
)
